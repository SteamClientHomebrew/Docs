              ...
              <div class="page-section-inner">
                <section id="footer-top" class="flex-container hide-mobile">
                  ...
                  <div class="footer-column">
                    ...
                    <a rel="noreferrer noopener" target="_blank" href="/discord" class="footer-column-item">
                      <span>Discord</span>
                    </a>
                    <a rel="noreferrer noopener" target="_blank" href="https://github.com/SteamClientHomebrew/Millennium/" class="footer-column-item">
                      <span>GitHub</span>
                    </a>
                  </div>
                  <div class="footer-column">
                    <h3 class="footer-column-header">Content</h3>
                    <a href="/themes" class="footer-column-item">
                      <span>Themes</span>
                    </a>
                    <a href="https://github.com/SteamClientHomebrew/Millennium/wiki" class="footer-column-item">
                      <span>Developers</span>
                    </a>
                  </div>
                  <div class="footer-column">
                    <h3 class="footer-column-header">Help</h3>
                    <a href="https://github.com/SteamClientHomebrew/Millennium/wiki" target="_blank" class="footer-column-item">Documentation</a>
                  </div>
                </section>
                <section id="footer-bottom" class="flex-container wrap align-center justify-between">
                  ...
                  <div class="flex-container wrap" id="footer-copyright-container">
                    <div class="footer-copyright text-center"> ©
                      <!-- -->2024
                      <!-- -->
                      <a class="anchor1" rel="noreferrer noopener" target="_blank" href="https://github.com/orgs/SteamClientHomebrew/people">Steam Client Homebrew</a>
                    </div>
                  ...
                  <div id="footer-social-icons" class="flex-container justify-center wrap">
                    <a rel="noreferrer noopener" target="_blank" href="/discord" class="social-icon discord">
                    ...
                    <a rel="noreferrer noopener" target="_blank" href="https://github.com/SteamClientHomebrew/Millennium/" class="social-icon github">
